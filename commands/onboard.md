...
If the output is `UNSET`, say: "It looks like this plugin wasn't installed via `claude plugin install`. Please reinstall it: `claude plugin install github:jerem-ai/ceo-claude-setup`" — then stop.
